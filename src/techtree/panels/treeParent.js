...
export default class TreeParent extends Component {
    ...
    updateTree(value) {
        ...
        switch (value) {
            case "Aztecs":
                this.fullUpg = ["Champion", "Elite Eagle Warrior"];
            ...
            case "Berbers":
                this.fullUpg = ["Elite Skirmisher", "Hand Cannoneer", "Elite Genitour", "Hussar", "Heavy Camel Rider", "Champion"]
            ...
            case "Britons":
                this.fullUpg = ["Champion", "Halberdier"];
            ...
            case "Bulgarians":
                this.fullUpg = ["Halberdier", "Hussar", "Paladin"];
            ...
            case "Burmese":
                this.fullUpg = ["Halberdier", "Champion", "Hussar"];
